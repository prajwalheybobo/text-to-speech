...
AUDIO_TOKENIZER_PATH = "/m nt/data/home/shared/models/higgs-audio-v2-3B/audio_tokenizer"
...
messages = [
    ...
    Message(
        role="user",
        content="A TTS system is a technology that converts written text into spoken words. But even so it is difficult to make one. The open source community is still new to these models and we are working on getting good results.This model is a state of the art competing with elevenlabs."
    ),
]
...
try:
    ...
    AudioSegment.from_wav("output3.wav").export("output2.mp3", format="mp3")
